      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 min-w-0">
            ...
            <section id="introduction" className={activeSection === 'introduction' ? 'block' : 'hidden'}>
            ...
            <section id="requirements" className={activeSection === 'requirements' ? 'block' : 'hidden'}>
            ...
            <section id="installation" className={activeSection === 'installation' ? 'block' : 'hidden'}>
            ...
            {/* Quick Start Section */}
            <section id="quickstart" className={activeSection === 'quickstart' ? 'block' : 'hidden'}>
...
workspace_path: /path/to/workspace`}
            ...
            <section id="project-manifests" className={activeSection === 'project-manifests' ? 'block' : 'hidden'}>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Project Manifests</h2>
              <div className="space-y-6">
                <div className="bg-white rounded-lg shadow-sm p-6">
...
custom_commands:          # Define project-specific commands
  - name: "reset-db"
    command: "php artisan migrate:fresh --seed"`}
            ...
            {/* Environment Section */}
            <section id="environment" className={activeSection === 'environment' ? 'block' : 'hidden'}>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Environment Management</h2>
              <div className="space-y-6">
                <div className="bg-white rounded-lg shadow-sm p-6">
                  <h3 className="text-xl font-semibold text-[#1a3a1a] mb-4">Secure Environment Sharing</h3>
                  <p className="text-gray-600 mb-6">
    ...
    ├── env/
        ...
        ├── myapp.env.enc    # Encrypted version for git`}</pre>
            ...
            <section id="commands" className={activeSection === 'commands' ? 'block' : 'hidden'}>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Commands Reference</h2>
              <div className="space-y-6">
                <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <section id="practices" className={activeSection === 'practices' ? 'block' : 'hidden'}>
            ...
            {/* Databases Section */}
            <section id="databases" className={activeSection === 'databases' ? 'block' : 'hidden'}>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Databases</h2>
              <div className="space-y-6">
                <div className="bg-white rounded-lg shadow-sm p-6">
